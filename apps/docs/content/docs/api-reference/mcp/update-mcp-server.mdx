...
<div className="mb-6">
  <h1 className="mb-2 text-2xl font-bold">Update Mcp Server</h1>
...
```bash
curl -X PATCH "http://localhost:8089/v1/mcp/servers/{id}" \
...
#### 200 Update MCP server configuration
