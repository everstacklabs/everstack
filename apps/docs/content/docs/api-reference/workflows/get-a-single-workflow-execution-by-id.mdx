---
title: "GET Get a single workflow execution by ID"
...
<div className="mb-6">
  <h1 className="mb-2 text-2xl font-bold">Get a single workflow execution by ID</h1>
  <div className="flex items-center gap-2">
    ...
    <code className="text-sm text-fd-muted-foreground">{"/v1/workflows/executions/{executionId}"}</code>
  </div>
</div>
...
<APIPlayground
  ...
  parameters={[{"name":"executionId","in":"path","required":true,"schema":{"type":"string"}},{"name":"tenantId","in":"query","required":false,"schema":{"type":"string"}}]}
/>
